...
class HelpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState : Bundle?) {
        ...
        supportFragmentManager.beginTransaction().replace(R.id.frame_layout_faq , FaqFragment())
                .commit()
        supportFragmentManager.beginTransaction()
                .replace(R.id.frame_layout_feedback , FeedbackFragment()).commit()
        ...
        return when (item.itemId) {
            R.id.dev_mail -> {
                ...
                emailIntent.putExtra(
                    ...
                    getString(R.string.feedback_for) + getString(R.string.app_name)
                )
