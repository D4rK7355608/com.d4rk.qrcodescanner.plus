...
import com.d4rk.qrcodescanner.plus.utils.extensions.parseOrNull
import com.d4rk.qrcodescanner.plus.utils.extensions.removePrefixIgnoreCase
import com.d4rk.qrcodescanner.plus.utils.extensions.removeStartAll
...
data class MeCard(
            ...
            text.removePrefixIgnoreCase(SCHEMA_PREFIX).split(PARAMETER_SEPARATOR)
                    .forEach { keyValue ->
                        if (keyValue.startsWithIgnoreCase(NAME_PREFIX)) {
                            val lastAndFirstNames = keyValue.removePrefixIgnoreCase(NAME_PREFIX)
    ...
    override fun toBarcodeText() : String {
        ...
        return StringBuilder().append(SCHEMA_PREFIX)
